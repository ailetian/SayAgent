...
class TransactionBoundaryTest {
    ...
    void indexingJobService_hasNoTransactionalAnywhere() throws Exception {
        Class<?> cls = Class.forName("com.sayagent.knowledge.service.IndexingJobService");
    ...
    void documentChunkReplaceChunks_isTransactionalOnPgManager() throws Exception {
        Class<?> repoCls = Class.forName("com.sayagent.knowledge.repository.DocumentChunkRepository");
