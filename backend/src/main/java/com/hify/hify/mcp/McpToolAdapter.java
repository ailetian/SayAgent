...
public class McpToolAdapter implements Tool {
    ...
    private final com.hify.hify.mcp.dto.ToolDefinition mcpDef;
    private final McpService mcpService;
    private static final ObjectMapper MAPPER = new ObjectMapper();

    public McpToolAdapter(Long serverId, com.hify.hify.mcp.dto.ToolDefinition mcpDef, McpService mcpService) {
